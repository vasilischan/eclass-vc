...
$langTimeConstraint = "Χρόνος";
$langHitConstraint = "Προσπάθειες";
$langExerciseEg = "π.χ.";
...
$langWikiNumberOfPages = "Αρ. σελίδων";
...
$langBBBNotifyUsers = "Ειδοποίηση $langsOfStudents για τον προγραμματισμό της τηλεδιάσκεψης";
...
$langBBBNoServerForRecording = "Η καταγραφή της τηλεσυνεργασίας δεν θα πραγματοποιηθεί αφού ο εξυπηρέτης δεν έχει ενεργοποιημένη αυτή τη δυνατότητα.";
